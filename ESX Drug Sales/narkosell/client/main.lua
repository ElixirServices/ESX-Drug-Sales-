local a={
    ...
    Citizen.CreateThread(function()
        ...
        AddEventHandler('tostdrugs:getcustomer',function()
            ...
            exports['mythic_notify']:SendAlert('inform', '„Darknet“ post information about the exchange, the customer will be here soon!', 6000)
                                     ...
                                     n=-35 else
                                         ...
                                         while B do 
                                            ...
                                            if D<=1.5 or o>=75 or q<100 then 
                                                B=false end end;if o>=50 
                                                or
                                                 q<1.0 then
                                                     exports['mythic_notify']:SendAlert('error', 'The customer canceled the order at the last minute, you can call a new one!', 6000)
                                                     ...
                                                     AddEventHandler('tostdrugs:infoPolicja',function(x,y,z)
                                                        if PlayerData.job~=nil and PlayerData.job.name=='police'then
                                                             ...
                                                             exports['mythic_notify']:SendAlert('error', 'Illegal activities in the area were reported to the police! '..F..'!', 6000)
